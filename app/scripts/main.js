        ...
        if(error) setData('get_peer_count',error,true);
          ...
          web3.eth.getSyncing(function(error,  result) {
            if (error)
              ...
              setData('node_syncing_status', result, false);

              // setData('syncing_information', 'Current Block ' + result.currentBlock +
              //                                '; Highest Block ' + result.highestBlock, false);
            }
          });
          ...
          web3.eth.getMining((error,  result) => {
            if (error)
              ...
              setData('node_mining_status', result);
            }
          })
        }
    });
